...
Lógica:
  1. Lee estado.json para saber si el mes esperado ya fue procesado.
  2. Hace scraping del BCRA buscando un nuevo .7z.
  3. Si lo encuentra y es nuevo: envía email de alerta.
  4. Si no lo encuentra: termina silenciosamente.
"""
...
def main() -> None:
    ...
    # 5. Exportar outputs para GitHub Actions
